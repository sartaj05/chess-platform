...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "analysis_type",
                    models.CharField(
                        choices=[("quick", "Quick"), ("deep", "Deep"), ("imported", "Imported")],
                        default="quick",
                        max_length=20,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="stockfish.stockfishengineprofile",
                    ),
                ),
                (
                    "game",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="analysis_jobs", to="games.game"
                    ),
                ),
                (
                    "requested_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "game",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="move_reviews", to="games.game"
                    ),
                ),
                (
                    "job",
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="review", to="games.gamemove"
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["game", "status"], name="analysis_job_game_status_idx"),
        ),
        migrations.AddIndex(
            model_name="gameanalysisjob",
            index=models.Index(fields=["status", "created_at"], name="analysis_job_status_time_idx"),
        ),
        migrations.AddIndex(
            model_name="openingbookline",
            index=models.Index(fields=["is_active", "eco"], name="analysis_opening_active_eco_idx"),
        ),
        migrations.AddIndex(
            model_name="openingbookline",
            index=models.Index(fields=["is_active", "name"], name="analysis_opening_active_name_idx"),
        ),
        migrations.AddIndex(
            model_name="openingexplorerquery",
            index=models.Index(fields=["created_at"], name="analysis_opening_query_time_idx"),
        ),
        migrations.AddIndex(
            model_name="positionanalysis",
            index=models.Index(fields=["game", "created_at"], name="analysis_pos_game_time_idx"),
        ),
        migrations.AddIndex(
            model_name="positionanalysis",
            index=models.Index(fields=["job", "created_at"], name="analysis_pos_job_time_idx"),
        ),
        migrations.AddIndex(
            model_name="movereview",
            index=models.Index(fields=["game", "ply_number"], name="analysis_review_game_ply_idx"),
        ),
        migrations.AddIndex(
            model_name="movereview",
            index=models.Index(fields=["classification", "created_at"], name="analysis_review_class_time_idx"),
        ),
        migrations.AddConstraint(
            model_name="gameanalysisjob",
            constraint=models.CheckConstraint(condition=models.Q(("depth__gte", 1)), name="analysis_depth_min_one"),
        ),
        migrations.AddConstraint(
            model_name="gameanalysisjob",
            constraint=models.CheckConstraint(
                condition=models.Q(("progress__lte", 100)), name="analysis_progress_max_100"
            ),
        ),
        migrations.AddConstraint(
            model_name="openingbookline",
            constraint=models.UniqueConstraint(fields=("eco", "pgn_prefix"), name="analysis_unique_eco_prefix"),
        ),
        migrations.AddConstraint(
            model_name="movereview",
            constraint=models.UniqueConstraint(fields=("job", "ply_number"), name="analysis_unique_review_job_ply"),
        ),

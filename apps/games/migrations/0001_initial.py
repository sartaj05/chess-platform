    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "initial_fen",
                    models.CharField(
                        default="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", max_length=150
                    ),
                ),
                (
                    "current_fen",
                ...
                (
                    "turn",
                    models.CharField(
                        choices=[("white", "White"), ("black", "Black")], db_index=True, default="white", max_length=5
                    ),
                ),
                ...
                (
                    "result",
                    models.CharField(
                        choices=[("*", "Ongoing"), ("1-0", "White wins"), ("0-1", "Black wins"), ("1/2-1/2", "Draw")],
                        db_index=True,
                        default="*",
                        max_length=12,
                    ),
                ...
                (
                    "winner_color",
                    models.CharField(blank=True, choices=[("white", "White"), ("black", "Black")], max_length=5),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("draw.offered", "Draw offered"),
                            ("draw.accepted", "Draw accepted"),
                            ("draw.declined", "Draw declined"),
                            ("takeback.offered", "Takeback offered"),
                            ("takeback.accepted", "Takeback accepted"),
                            ("takeback.declined", "Takeback declined"),
                            ("clock.timeout", "Clock timeout"),
                            ("game.chat", "Game chat"),
                ...
                (
                    "game",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="events", to="games.game"
                    ),
                ),
            ],
            options={"ordering": ["created_at"]},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(choices=[("white", "White"), ("black", "Black")], db_index=True, max_length=5),
                ),
        ...
        migrations.AddIndex(
            model_name="game", index=models.Index(fields=["status", "created_at"], name="games_game_status_created_idx")
        ),
        migrations.AddIndex(
            model_name="game", index=models.Index(fields=["rated", "status"], name="games_game_rated_status_idx")
        ),
        migrations.AddIndex(
            model_name="game", index=models.Index(fields=["white_user", "created_at"], name="games_game_white_user_idx")
        ),
        migrations.AddIndex(
            model_name="game", index=models.Index(fields=["black_user", "created_at"], name="games_game_black_user_idx")
        ),
        migrations.AddIndex(model_name="game", index=models.Index(fields=["room"], name="games_game_room_idx")),
        migrations.AddConstraint(
            model_name="game",
            constraint=models.CheckConstraint(
                condition=models.Q(("clock_initial_ms__gte", 0)), name="games_clock_initial_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="game",
            constraint=models.CheckConstraint(
                condition=models.Q(("white_time_ms__gte", 0)), name="games_white_time_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="game",
            constraint=models.CheckConstraint(
                condition=models.Q(("black_time_ms__gte", 0)), name="games_black_time_nonnegative"
            ),
        ),
        migrations.AddIndex(
            model_name="gamemove", index=models.Index(fields=["game", "ply_number"], name="games_move_game_ply_idx")
        ),
        migrations.AddIndex(
            model_name="gamemove", index=models.Index(fields=["game", "move_number"], name="games_move_game_move_idx")
        ),
        migrations.AddConstraint(
            model_name="gamemove",
            constraint=models.UniqueConstraint(fields=("game", "ply_number"), name="games_unique_ply_per_game"),
        ),
        migrations.AddIndex(
            model_name="gameevent",
            index=models.Index(fields=["game", "event_type", "created_at"], name="games_event_game_type_idx"),
        ),
        migrations.AddIndex(
            model_name="gameevent", index=models.Index(fields=["game", "created_at"], name="games_event_game_time_idx")
        ),
    ]

...
class UserAdmin(DjangoUserAdmin):
    ...
    list_filter = ("is_active", "is_staff", "is_superuser", "is_email_verified", "two_factor_enabled")
    ...
    fieldsets = (
        ...
        ("Security", {"fields": ("is_email_verified", "two_factor_enabled", "totp_secret")}),
        ("Permissions", {"fields": ("is_active", "is_staff", "is_superuser", "groups", "user_permissions")}),
        ("Important dates", {"fields": ("last_login", "date_joined", "last_seen_at")}),
    )
    add_fieldsets = (
        (
            None,
            {
                "classes": ("wide",),
                "fields": ("email", "password1", "password2", "is_email_verified", "is_staff", "is_active"),
            },
        ),
    )

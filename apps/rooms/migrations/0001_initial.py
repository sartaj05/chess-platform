        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visibility",
                    models.CharField(
                        choices=[("public", "Public"), ("private", "Private"), ("invite_only", "Invite only")],
                        db_index=True,
                        default="private",
                        max_length=16,
                    ),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=Q(("clock_initial_seconds__gte", 0)), name="rooms_room_clock_nonnegative"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("host", "Host"), ("player", "Player"), ("spectator", "Spectator")],
                        db_index=True,
                        default="player",
                        max_length=16,
                    ),
                ...
                (
                    "side",
                    models.CharField(
                        choices=[("white", "White"), ("black", "Black"), ("random", "Random"), ("none", "None")],
                        default="random",
                        max_length=8,
                    ),
                ),
                ...
                (
                    "room",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="participants", to="rooms.room"
                    ),
                ),
                (
                    "user",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        condition=Q(("user__isnull", False)), fields=("room", "user"), name="rooms_unique_user_per_room"
                    ),
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="events", to="rooms.room"
                    ),
                ),
            ],
            options={

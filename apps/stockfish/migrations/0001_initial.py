...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("success", "Success"), ("failed", "Failed"), ("unavailable", "Unavailable")],
                        db_index=True,
                        default="success",
                        max_length=20,
                    ),
        ...
        migrations.AddIndex(
            model_name="stockfishengineprofile",
            index=models.Index(fields=["is_active", "name"], name="stockfish_profile_active_idx"),
        ),
        migrations.AddIndex(
            model_name="stockfishrun",
            index=models.Index(fields=["status", "created_at"], name="stockfish_run_status_time_idx"),
        ),
        migrations.AddIndex(
            model_name="stockfishrun",
            index=models.Index(fields=["game", "created_at"], name="stockfish_run_game_time_idx"),
        ),
        migrations.AddConstraint(
            model_name="stockfishengineprofile",
            constraint=models.CheckConstraint(
                condition=models.Q(("default_depth__gte", 1)), name="stockfish_depth_min_one"
            ),
        ),
        migrations.AddConstraint(
            model_name="stockfishengineprofile",
            constraint=models.CheckConstraint(
                condition=models.Q(("skill_level__lte", 20)), name="stockfish_skill_max_twenty"
            ),
        ),
        migrations.AddConstraint(
            model_name="stockfishengineprofile",
            constraint=models.CheckConstraint(
                condition=models.Q(("threads__gte", 1)), name="stockfish_threads_min_one"
            ),
        ),
        migrations.AddConstraint(
            model_name="stockfishengineprofile",
            constraint=models.CheckConstraint(condition=models.Q(("hash_mb__gte", 1)), name="stockfish_hash_min_one"),
        ),

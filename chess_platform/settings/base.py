...
STOCKFISH_BINARY = env("STOCKFISH_BINARY", default="/usr/games/stockfish")
STOCKFISH_DEFAULT_DEPTH = env.int("STOCKFISH_DEFAULT_DEPTH", default=12)
STOCKFISH_DEFAULT_MOVETIME_MS = env.int("STOCKFISH_DEFAULT_MOVETIME_MS", default=750)
STOCKFISH_THREADS = env.int("STOCKFISH_THREADS", default=1)
STOCKFISH_HASH_MB = env.int("STOCKFISH_HASH_MB", default=64)
...
MIDDLEWARE = [
    ...
    "apps.core.middleware.RequestTelemetryMiddleware",

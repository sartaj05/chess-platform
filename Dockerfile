...
WORKDIR /app
RUN apt-get update && apt-get install -y --no-install-recommends build-essential libpq-dev netcat-openbsd gettext curl ca-certificates && rm -rf /var/lib/apt/lists/*
